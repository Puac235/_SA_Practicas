...
router.get('/estado_restaurante', controller.estadoRestaurante); // Verificar el estado del pedido segun restaurante
router.get('/estado_repartidor', controller.estadoRepartidor); // Verificar el estado del pedido segun repartidor
